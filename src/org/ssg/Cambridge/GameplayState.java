...
public class GameplayState extends BasicGameState implements KeyListener{
	...
	public void initFields(GameContainer gc) throws SlickException{
		...
		//PlayerPuffer p1 = new PlayerPuffer(0, playerConsts, new int[]{FIELDWIDTH,FIELDHEIGHT}, p1Controls, c1, c1Exist, p1Start, p1lim, Color.orange, mySoundSystem, "slow1", slice);
